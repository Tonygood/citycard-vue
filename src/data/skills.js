...
export const SKILL_RESTRICTIONS = {
  ...
  '趁其不备': { cooldown: 0, limit: 2 },
  '搬运救兵': { cooldown: 0, limit: 2 },
  ...
  '以礼来降': { cooldown: 0, limit: 2 }, // 每局限2次
  '强制转移·高级': { cooldown: 0, limit: 1 },
  '四面楚歌': { cooldown: 0, limit: 0 }, // 无次数限制
