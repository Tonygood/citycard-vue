...
const changelog = [
  { date: '2026.5.24', version: 'V1.0.12', desc: '修复了一些bug' },
  { date: '2026.5.18', version: 'V1.0.11', desc: '更新了金币技能苟延残喘和以礼来降' },
  { date: '2026.5.16', version: 'V1.0.10', desc: '更新了金币技能无懈可击、时来运转、人质交换和李代桃僵' },
