...
function initBattleData() {
  ...
  debugLog('[BattleAnimation] 初始化战斗数据', props.battleData)
  debugLog('[BattleAnimation] props.battleData.specialEvent:', props.battleData.specialEvent)
  ...
  debugLog('[BattleAnimation] specialEvent设置为:', specialEvent.value)
  debugLog('[BattleAnimation] player1城市数量:', Object.keys(player1.value.cities).length)
  debugLog('[BattleAnimation] player2城市数量:', Object.keys(player2.value.cities).length)
  debugLog('[BattleAnimation] player1总攻击力:', player1.value.totalAttack)
  debugLog('[BattleAnimation] player2总攻击力:', player2.value.totalAttack)
}
...
async function playAnimationSequence() {
  ...
  debugLog('[BattleAnimation] 开始播放动画序列')
...
async function playFatigueAnimation(fatiguedCities) {
  debugLog('[BattleAnimation] 播放疲劳减半动画', fatiguedCities)
...
async function playHpChangeAnimation(hpChanges) {
  debugLog('[BattleAnimation] 播放HP变化动画', hpChanges)
...
async function playDestroyAnimation(destroyedCities) {
  debugLog('[BattleAnimation] 播放城市阵亡动画', destroyedCities)
...
async function playSurrenderAnimation() {
  debugLog('[BattleAnimation] 播放归顺动画')
